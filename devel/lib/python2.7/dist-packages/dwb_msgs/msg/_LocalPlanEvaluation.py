...
class LocalPlanEvaluation(genpy.Message):
  _md5sum = "e27627a24709d55410c81b10aaa894ed"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_2H.pack(_x.best_index, _x.worst_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.best_index, _x.worst_index,) = _struct_2H.unpack(str[start:end])
      return self
