...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3d.pack(_x.current_vel.x, _x.current_vel.y, _x.current_vel.theta))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.current_vel.x, _x.current_vel.y, _x.current_vel.theta,) = _struct_3d.unpack(str[start:end])
      return self
