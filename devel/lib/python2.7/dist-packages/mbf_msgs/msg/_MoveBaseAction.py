...
class MoveBaseAction(genpy.Message):
  _md5sum = "dbfe77d44df1e2942b5b7ce800115d67"
...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.action_result.result.outcome))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2f3I.pack(_x.action_result.result.dist_to_goal, _x.action_result.result.angle_to_goal, _x.action_result.result.final_pose.header.seq, _x.action_result.result.final_pose.header.stamp.secs, _x.action_result.result.final_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_result.result.final_pose.pose.position.x, _x.action_result.result.final_pose.pose.position.y, _x.action_result.result.final_pose.pose.position.z, _x.action_result.result.final_pose.pose.orientation.x, _x.action_result.result.final_pose.pose.orientation.y, _x.action_result.result.final_pose.pose.orientation.z, _x.action_result.result.final_pose.pose.orientation.w, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2f3I.pack(_x.action_feedback.feedback.dist_to_goal, _x.action_feedback.feedback.angle_to_goal, _x.action_feedback.feedback.current_pose.header.seq, _x.action_feedback.feedback.current_pose.header.stamp.secs, _x.action_feedback.feedback.current_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d3I.pack(_x.action_feedback.feedback.current_pose.pose.position.x, _x.action_feedback.feedback.current_pose.pose.position.y, _x.action_feedback.feedback.current_pose.pose.position.z, _x.action_feedback.feedback.current_pose.pose.orientation.x, _x.action_feedback.feedback.current_pose.pose.orientation.y, _x.action_feedback.feedback.current_pose.pose.orientation.z, _x.action_feedback.feedback.current_pose.pose.orientation.w, _x.action_feedback.feedback.current_twist.header.seq, _x.action_feedback.feedback.current_twist.header.stamp.secs, _x.action_feedback.feedback.current_twist.header.stamp.nsecs))
      _x = self.action_feedback.feedback.current_twist.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_6d.pack(_x.action_feedback.feedback.current_twist.twist.linear.x, _x.action_feedback.feedback.current_twist.twist.linear.y, _x.action_feedback.feedback.current_twist.twist.linear.z, _x.action_feedback.feedback.current_twist.twist.angular.x, _x.action_feedback.feedback.current_twist.twist.angular.y, _x.action_feedback.feedback.current_twist.twist.angular.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w,) = _struct_7d.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_result.result.outcome,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.dist_to_goal, _x.action_result.result.angle_to_goal, _x.action_result.result.final_pose.header.seq, _x.action_result.result.final_pose.header.stamp.secs, _x.action_result.result.final_pose.header.stamp.nsecs,) = _struct_2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.dist_to_goal, _x.action_feedback.feedback.angle_to_goal, _x.action_feedback.feedback.current_pose.header.seq, _x.action_feedback.feedback.current_pose.header.stamp.secs, _x.action_feedback.feedback.current_pose.header.stamp.nsecs,) = _struct_2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.action_feedback.feedback.current_twist.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.action_feedback.feedback.current_twist.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 48
      (_x.action_feedback.feedback.current_twist.twist.linear.x, _x.action_feedback.feedback.current_twist.twist.linear.y, _x.action_feedback.feedback.current_twist.twist.linear.z, _x.action_feedback.feedback.current_twist.twist.angular.x, _x.action_feedback.feedback.current_twist.twist.angular.y, _x.action_feedback.feedback.current_twist.twist.angular.z,) = _struct_6d.unpack(str[start:end])
      return self
