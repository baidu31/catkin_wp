...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.result.path.header.seq, _x.result.path.header.stamp.secs, _x.result.path.header.stamp.nsecs))
      ...
      buff.write(_struct_d.pack(self.result.cost))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.path.header.seq, _x.result.path.header.stamp.secs, _x.result.path.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.result.cost,) = _struct_d.unpack(str[start:end])
      return self
