...
class MoveBaseActionResult(genpy.Message):
  _md5sum = "685f5859e23a95b093d01753e8cb600c"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_I.pack(self.result.outcome))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_2f3I.pack(_x.result.dist_to_goal, _x.result.angle_to_goal, _x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_7d.pack(_x.result.final_pose.pose.position.x, _x.result.final_pose.pose.position.y, _x.result.final_pose.pose.position.z, _x.result.final_pose.pose.orientation.x, _x.result.final_pose.pose.orientation.y, _x.result.final_pose.pose.orientation.z, _x.result.final_pose.pose.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.outcome,) = _struct_I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.result.dist_to_goal, _x.result.angle_to_goal, _x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs,) = _struct_2f3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
