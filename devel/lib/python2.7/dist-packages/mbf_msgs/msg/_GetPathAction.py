...
class GetPathAction(genpy.Message):
  _md5sum = "89ded86da8218b43d5c91112dae98224"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_B3I.pack(_x.action_goal.goal.use_start_pose, _x.action_goal.goal.start_pose.header.seq, _x.action_goal.goal.start_pose.header.stamp.secs, _x.action_goal.goal.start_pose.header.stamp.nsecs))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_8d.pack(_x.action_goal.goal.target_pose.pose.position.x, _x.action_goal.goal.target_pose.pose.position.y, _x.action_goal.goal.target_pose.pose.position.z, _x.action_goal.goal.target_pose.pose.orientation.x, _x.action_goal.goal.target_pose.pose.orientation.y, _x.action_goal.goal.target_pose.pose.orientation.z, _x.action_goal.goal.target_pose.pose.orientation.w, _x.action_goal.goal.tolerance))
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.action_result.result.path.header.seq, _x.action_result.result.path.header.stamp.secs, _x.action_result.result.path.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_struct_d3I.pack(_x.action_result.result.cost, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.use_start_pose, _x.action_goal.goal.start_pose.header.seq, _x.action_goal.goal.start_pose.header.stamp.secs, _x.action_goal.goal.start_pose.header.stamp.nsecs,) = _struct_B3I.unpack(str[start:end])
      ...
      (_x.action_goal.goal.start_pose.pose.position.x, _x.action_goal.goal.start_pose.pose.position.y, _x.action_goal.goal.start_pose.pose.position.z, _x.action_goal.goal.start_pose.pose.orientation.x, _x.action_goal.goal.start_pose.pose.orientation.y, _x.action_goal.goal.start_pose.pose.orientation.z, _x.action_goal.goal.start_pose.pose.orientation.w, _x.action_goal.goal.target_pose.header.seq, _x.action_goal.goal.target_pose.header.stamp.secs, _x.action_goal.goal.target_pose.header.stamp.nsecs,) = _struct_7d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.path.header.seq, _x.action_result.result.path.header.stamp.secs, _x.action_result.result.path.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.cost, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_d3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
