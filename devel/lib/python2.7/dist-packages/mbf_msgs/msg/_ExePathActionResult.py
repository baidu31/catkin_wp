...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_3I.pack(_x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.final_pose.header.seq, _x.result.final_pose.header.stamp.secs, _x.result.final_pose.header.stamp.nsecs,) = _struct_3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.result.final_pose.pose.position.x, _x.result.final_pose.pose.position.y, _x.result.final_pose.pose.position.z, _x.result.final_pose.pose.orientation.x, _x.result.final_pose.pose.orientation.y, _x.result.final_pose.pose.orientation.z, _x.result.final_pose.pose.orientation.w, _x.result.dist_to_goal, _x.result.angle_to_goal,) = _struct_7d2f.unpack(str[start:end])
      return self
