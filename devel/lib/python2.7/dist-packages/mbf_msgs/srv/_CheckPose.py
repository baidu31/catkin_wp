...
class CheckPoseRequest(genpy.Message):
  _md5sum = "554c9d2f8767c05bb078a8940caaf078"
...
"""
  ...
  __slots__ = ['pose','safety_dist','costmap','current_pose']
  _slot_types = ['geometry_msgs/PoseStamped','float32','uint8','bool']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       pose,safety_dist,costmap,current_pose
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_7df2B.pack(_x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w, _x.safety_dist, _x.costmap, _x.current_pose))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.pose.pose.position.x, _x.pose.pose.position.y, _x.pose.pose.position.z, _x.pose.pose.orientation.x, _x.pose.pose.orientation.y, _x.pose.pose.orientation.z, _x.pose.pose.orientation.w, _x.safety_dist, _x.costmap, _x.current_pose,) = _struct_7df2B.unpack(str[start:end])
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_BI.pack(_x.state, _x.cost))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.state, _x.cost,) = _struct_BI.unpack(str[start:end])
      return self
    except struct.error as e:
      raise genpy.DeserializationError(e) #most likely buffer underfill
...
class CheckPose(object):
  ...
  _md5sum = 'a1877f54267ab12e26c8d2b2a5ae391c'
