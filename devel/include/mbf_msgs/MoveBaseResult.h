...
struct MoveBaseResult_
{
  ...
  _final_pose_type final_pose;
    ...
    enum { SUCCESS = 0u };
     enum { FAILURE = 10u };
     enum { CANCELED = 11u };
     enum { PAT_EXCEEDED = 12u };
     enum { COLLISION = 13u };
     enum { OSCILLATION = 14u };
     enum { ROBOT_STUCK = 15u };
     enum { START_BLOCKED = 16u };
     enum { GOAL_BLOCKED = 17u };
     enum { TF_ERROR = 18u };
     enum { INVALID_PLUGIN = 19u };
     enum { INTERNAL_ERROR = 20u };
     enum { PLAN_FAILURE = 50u };
     enum { CTRL_FAILURE = 100u };
...
struct MD5Sum< ::mbf_msgs::MoveBaseResult_<ContainerAllocator> >
{
  ...
  {
    return "88a3b817098a081f3982a20a1b915e4c";
  }

  static const char* value(const ::mbf_msgs::MoveBaseResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x88a3b817098a081fULL;
  static const uint64_t static_value2 = 0x3982a20a1b915e4cULL;
};
