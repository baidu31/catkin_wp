...
struct RecoveryResult_
{
  ...
  _used_plugin_type used_plugin;
    ...
    enum { SUCCESS = 0u };
     enum { FAILURE = 150u };
     enum { CANCELED = 151u };
     enum { PAT_EXCEEDED = 152u };
     enum { INVALID_NAME = 153u };
     enum { INTERNAL_ERROR = 154u };
...
struct MD5Sum< ::mbf_msgs::RecoveryResult_<ContainerAllocator> >
{
  ...
  {
    return "16113597a3266267323624ed50962fa5";
  }

  static const char* value(const ::mbf_msgs::RecoveryResult_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x16113597a3266267ULL;
  static const uint64_t static_value2 = 0x323624ed50962fa5ULL;
};
...
uint8 INVALID_NAME   = 153  # behavior name not recognized\n\
uint8 INTERNAL_ERROR = 154\n\
