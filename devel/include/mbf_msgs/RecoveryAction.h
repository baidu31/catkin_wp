...
struct MD5Sum< ::mbf_msgs::RecoveryAction_<ContainerAllocator> >
{
  ...
  {
    return "849d7ff975bef1f590d109308af58ee7";
  }

  static const char* value(const ::mbf_msgs::RecoveryAction_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x849d7ff975bef1f5ULL;
  static const uint64_t static_value2 = 0x90d109308af58ee7ULL;
};
