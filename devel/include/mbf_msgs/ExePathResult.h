...
struct ExePathResult_
{
  ...
  _angle_to_goal_type angle_to_goal;
    ...
    enum { SUCCESS = 0u };
     enum { FAILURE = 100u };
     enum { CANCELED = 101u };
     enum { NO_VALID_CMD = 102u };
     enum { PAT_EXCEEDED = 103u };
     enum { COLLISION = 104u };
     enum { OSCILLATION = 105u };
     enum { ROBOT_STUCK = 106u };
     enum { MISSED_GOAL = 107u };
     enum { MISSED_PATH = 108u };
     enum { BLOCKED_PATH = 109u };
     enum { INVALID_PATH = 110u };
     enum { TF_ERROR = 111u };
     enum { NOT_INITIALIZED = 112u };
     enum { INVALID_PLUGIN = 113u };
     enum { INTERNAL_ERROR = 114u };
