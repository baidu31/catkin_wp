...
struct MD5Sum< ::mbf_msgs::GetPathActionGoal_<ContainerAllocator> >
{
  ...
  {
    return "3e6f59ce9beab05a9cad5f63976b31e6";
  }

  static const char* value(const ::mbf_msgs::GetPathActionGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3e6f59ce9beab05aULL;
  static const uint64_t static_value2 = 0x9cad5f63976b31e6ULL;
};
