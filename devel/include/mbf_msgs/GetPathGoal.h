...
struct MD5Sum< ::mbf_msgs::GetPathGoal_<ContainerAllocator> >
{
  ...
  {
    return "ba13b35f05b074f8a047d8b90cb39686";
  }

  static const char* value(const ::mbf_msgs::GetPathGoal_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xba13b35f05b074f8ULL;
  static const uint64_t static_value2 = 0xa047d8b90cb39686ULL;
};
