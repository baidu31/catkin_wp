...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_leds-srv:<Trigger-request> is deprecated: use robotino_leds-srv:Trigger-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <Trigger-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Trigger-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotino_leds-srv:<Trigger-response> is deprecated: use robotino_leds-srv:Trigger-response instead.")))
