...
(cl:defmethod duration-val ((m <Trajectory2D>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dwb_msgs-msg:duration-val is deprecated.  Use dwb_msgs-msg:duration instead.")
  (duration m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Trajectory2D>)))
  ...
  "8e70718073b0509259f298a98dd71876")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Trajectory2D)))
  "Returns md5sum for a message object of type 'Trajectory2D"
  "8e70718073b0509259f298a98dd71876")
