...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveBaseResult>)))
  ...
  "88a3b817098a081f3982a20a1b915e4c")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveBaseResult)))
  "Returns md5sum for a message object of type 'MoveBaseResult"
  "88a3b817098a081f3982a20a1b915e4c")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MoveBaseResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%~%# Predefined success codes:~%uint8 SUCCESS        = 0~%~%# Predefined general error codes:~%uint8 FAILURE        = 10~%uint8 CANCELED       = 11~%uint8 PAT_EXCEEDED   = 12~%uint8 COLLISION      = 13~%uint8 OSCILLATION    = 14~%uint8 ROBOT_STUCK    = 15~%uint8 START_BLOCKED  = 16~%uint8 GOAL_BLOCKED   = 17~%uint8 TF_ERROR       = 18~%uint8 INVALID_PLUGIN = 19~%uint8 INTERNAL_ERROR = 20~%# 21..49 are reserved for future general error codes~%~%# Planning/controlling failures:~%uint8 PLAN_FAILURE   = 50~%# 51..99 are reserved as global planner specific errors~%~%uint8 CTRL_FAILURE   = 100~%# 101..149 are reserved as local planner specific errors~%~%uint32 outcome~%string message~%~%# Configuration upon action completion~%float32 dist_to_goal~%float32 angle_to_goal~%geometry_msgs/PoseStamped final_pose~%~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MoveBaseResult)))
  "Returns full string definition for message of type 'MoveBaseResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%~%# Predefined success codes:~%uint8 SUCCESS        = 0~%~%# Predefined general error codes:~%uint8 FAILURE        = 10~%uint8 CANCELED       = 11~%uint8 PAT_EXCEEDED   = 12~%uint8 COLLISION      = 13~%uint8 OSCILLATION    = 14~%uint8 ROBOT_STUCK    = 15~%uint8 START_BLOCKED  = 16~%uint8 GOAL_BLOCKED   = 17~%uint8 TF_ERROR       = 18~%uint8 INVALID_PLUGIN = 19~%uint8 INTERNAL_ERROR = 20~%# 21..49 are reserved for future general error codes~%~%# Planning/controlling failures:~%uint8 PLAN_FAILURE   = 50~%# 51..99 are reserved as global planner specific errors~%~%uint8 CTRL_FAILURE   = 100~%# 101..149 are reserved as local planner specific errors~%~%uint32 outcome~%string message~%~%# Configuration upon action completion~%float32 dist_to_goal~%float32 angle_to_goal~%geometry_msgs/PoseStamped final_pose~%~%~%================================================================================~%MSG: geometry_msgs/PoseStamped~%# A Pose with reference coordinate frame and timestamp~%Header header~%Pose pose~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Pose~%# A representation of pose in free space, composed of postion and orientation. ~%Point position~%Quaternion orientation~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%================================================================================~%MSG: geometry_msgs/Quaternion~%# This represents an orientation in free space in quaternion form.~%~%float64 x~%float64 y~%float64 z~%float64 w~%~%~%"))
