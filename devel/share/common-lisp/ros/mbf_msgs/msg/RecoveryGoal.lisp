...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<RecoveryGoal>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Run one of the recovery behavior listed on recovery_behaviors parameter~%~%string behavior~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'RecoveryGoal)))
  "Returns full string definition for message of type 'RecoveryGoal"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# Run one of the recovery behavior listed on recovery_behaviors parameter~%~%string behavior~%~%~%~%"))
