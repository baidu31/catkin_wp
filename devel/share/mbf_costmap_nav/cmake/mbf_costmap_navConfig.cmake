...
if("TRUE" STREQUAL "TRUE")
  set(mbf_costmap_nav_SOURCE_PREFIX /home/nic/catkin_wp/src/move_base_flex/mbf_costmap_nav)
  set(mbf_costmap_nav_DEVEL_PREFIX /home/nic/catkin_wp/devel)
  ...
  set(mbf_costmap_nav_INSTALL_PREFIX /home/nic/catkin_wp/install)
...
if(NOT "/home/nic/catkin_wp/devel/include;/home/nic/catkin_wp/src/move_base_flex/mbf_costmap_nav/include;/usr/include " STREQUAL " ")
  set(mbf_costmap_nav_INCLUDE_DIRS "")
  set(_include_dirs "/home/nic/catkin_wp/devel/include;/home/nic/catkin_wp/src/move_base_flex/mbf_costmap_nav/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'mbf_costmap_nav' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Sebastian Pütz <spuetz@uos.de>, Jorge Santos <santos@magazino.eu>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'mbf_costmap_nav' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nic/catkin_wp/src/move_base_flex/mbf_costmap_nav/${idir}'.  Ask the maintainer 'Sebastian Pütz <spuetz@uos.de>, Jorge Santos <santos@magazino.eu>' to fix it.")
    endif()
    _list_append_unique(mbf_costmap_nav_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "mbf_costmap_server;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mbf_costmap_nav_dep}_FOUND)
      find_package(${mbf_costmap_nav_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mbf_costmap_nav_dep} REQUIRED ${depend_list})
  endif()
