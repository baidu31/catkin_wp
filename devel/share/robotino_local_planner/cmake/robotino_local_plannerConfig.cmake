...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robotino_local_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nic/catkin_wp/src/ros-indigo-robotino/robotino_local_planner/${idir}'.  Ask the maintainer 'Audeliano Wolian Li <audeliano@gmail.com>' to fix it.")
    endif()
