...
class NavTest():
    def __init__(self):
        ...
        locations['A_1'] = Pose(Point(-0.016, -2.357, 0.000), Quaternion(0.000, 0.000, 0.133, 0.991))
        locations['A_2'] = Pose(Point(-0.039, -2.618, 0.000), Quaternion(0.000, 0.000, 0.099, 0.995))
        locations['B_1'] = Pose(Point(-4.171, 1.740, 0.000), Quaternion(0.000, 0.000, 0.133, 0.991))
        locations['B_2'] = Pose(Point(-4.141, 1.908, 0.000), Quaternion(0.000, 0.000, 0.140, 0.990))
